...
export default function PostContainer({ post, user, files, currentUser, loading, fileLoading, postRef: ref, ...modalControl }) {
  ...
  return (
    ...
    >
      ...
      <ModalContent h={'full'} borderRadius={0}  bgRepeat={'no-repeat !important'} bgPosition={'unset'} bgSize={'cover !important'} bg={`url('/images/bg.jpg')`} overflow={'scroll'}>
       <Box h={'full'} bg={'rgba(255,255,255,0.8)'} backdropFilter={'blur(10px)'}>
       <ModalCloseButton />
        <ModalBody pt={50}>
